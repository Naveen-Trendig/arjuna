...
if not os.path.exists(gui_dir):  # frozen executable path
    gui_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'ui')

server = Flask(__name__, static_folder=gui_dir_abs, template_folder=gui_dir_abs)
...
def choose_path():
    ...
    if dirs and len(dirs) > 0:
        ...
        listdir = app.traverse_folders(directory)
        print(listdir)
        app.logger.info(listdir)
